...
find busybox-1.18.5/ -name "*.macroDbg"     |while read i; do echo $i; rm $i; done
find busybox-1.18.5/ -name "*.dbgSrc"       |while read i; do echo $i; rm $i; done
...
#find busybox-1.18.5/ -name "*.vaareportall" |while read i; do echo $i; rm $i; done
#find busybox-1.18.5/ -name "*.errreport"    |while read i; do echo $i; rm $i; done
